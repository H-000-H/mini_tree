 ...
 * @param dev device 指针
 * @return compatible 字符串, dev 无效返回 NULL
 */
 ...
 * @param dev device 指针
 * @return 设备状态枚举, dev 无效返回 DEVICE_STATUS_DISABLED
 */
 ...
 * @param dev device 指针
 * @return 关键性枚举, dev 无效返回 DEVICE_CRIT_WARNING
 */
