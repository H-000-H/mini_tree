...
struct bus_controller_ops {
    int  (*init)(struct device* dev, const void* cfg);                                              /**< 初始化 host */
    int  (*deinit)(struct device* dev);              /**< 反初始化 host (返回 int, BUSY 时不销毁) */
    int  (*role)(struct device* dev);                /**< 查询角色 (MASTER/SLAVE) */
    int  (*client_register)(struct device* dev, const void* cfg, void** out);  /**< 注册 client */
    void (*client_unregister)(struct device* dev);   /**< 注销 client */
};
/*===========================================================================================================================================================*/
 ...
 */
typedef void (*bus_async_user_cb_t)(struct device* dev, const void* trans, void* userdata);
