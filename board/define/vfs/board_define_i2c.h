...
#endif
#ifndef DTC_GEN_COUNT_MT_I2C_SLAVE
#define DTC_GEN_COUNT_MT_I2C_SLAVE 1
#endif
#ifndef I2C_VFS_PRIV_COUNT
#define I2C_VFS_PRIV_COUNT (DTC_GEN_COUNT_MT_I2C_MASTER + DTC_GEN_COUNT_MT_I2C_SLAVE)
#endif

/* client 池 = 两个 client compatible 节点数之和 (缺省各 1) */
#ifndef DTC_GEN_COUNT_MT_I2C_MASTER_CLIENT
#define DTC_GEN_COUNT_MT_I2C_MASTER_CLIENT 1
#endif
#ifndef DTC_GEN_COUNT_MT_I2C_SLAVE_CLIENT
#define DTC_GEN_COUNT_MT_I2C_SLAVE_CLIENT 1
#endif
#ifndef I2C_VFS_CLIENT_COUNT
#define I2C_VFS_CLIENT_COUNT (DTC_GEN_COUNT_MT_I2C_MASTER_CLIENT + DTC_GEN_COUNT_MT_I2C_SLAVE_CLIENT)
#endif
