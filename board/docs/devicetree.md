# mini_tree 设备树说明 / Device Tree Notes
...
## 文件布局（Linux 写法；dts / dtsi 分目录）/ File Layout (Linux Style; dts / dtsi in Separate Directories)
...
## dtc-lite 编译流水线 / dtc-lite Compilation Pipeline
...
详见 [docs/driver_guide.md](../../docs/driver_guide.md)、[docs/porting_guide.md](../../docs/porting_guide.md)。
See [docs/driver_guide.md](../../docs/driver_guide.md) and [docs/porting_guide.md](../../docs/porting_guide.md).
