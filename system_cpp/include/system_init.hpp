...
/* 用户工程在 main() 中按此顺序调用: */
/* int main(void) { */
/* mini_tree::system_pre_os_init();      // [1] 框架预初始化 (EventBus, 安全, IWDG, */
/* 关全局中断) platform_register_all_drivers();     // 向 VFS 注册平台驱动 MyApp::init_services(); */
/* // 用户业务服务 init() */
/* mini_tree::system_start_tasks();      // [2] driver probe, TWDT, scrubber */
