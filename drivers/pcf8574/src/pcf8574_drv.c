 ...
 */
pre_execution(160)
static void pcf8574_pool_boot_init(void)
{
 ...
 */
static struct pcf8574_device* pcf8574_get_drvdata(struct device* dev)
{
    return (struct pcf8574_device*)device_get_priv(dev);
}
 ...
 */
static int pcf8574_open(struct device* dev, void* arg)
{
 ...
 */
static int pcf8574_close(struct device* dev)
{
    struct pcf8574_device* d;
    struct dev_lifecycle* lc;
    int last;
...
struct pcf8574_ioctl_map { pcf8574_ioctl_fn_t handler; };
 ...
 */
static int pcf8574_ioctl(struct device* dev, int cmd, void* arg, size_t arg_len, uint32_t ms)
{
    struct pcf8574_device* d;
    struct dev_lifecycle* lc;
    int32_t off;
 ...
 */
static int pcf8574_probe(struct device* dev)
{
    struct pcf8574_device* d;
    int pool_idx, ret;
    if (!dev)
 ...
 */
static int pcf8574_remove(struct device* dev)
{
    struct pcf8574_device* d;
    struct dev_lifecycle* lc;
    int idx;
