 ...
 */
pre_execution(PRE_EXEC_PRIO_DRIVER_POOL) static void at24c02_pool_boot_init(void) { COMPAT_IGNORE_RESULT(osal_pool_init(&s_at24c02_pool_ctrl, s_at24c02_used, AT24C02_POOL_COUNT)); }
