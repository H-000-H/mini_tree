 ...
 */
pre_execution(160) static void bmp280_pool_boot_init(void)
{
 ...
 * @return VFS_OK 或 VFS_ERR_*
 */
static int bmp280_read_regs(struct bmp280_device* d, uint8_t start, uint8_t* buf, size_t len,
                            uint32_t to)
{
