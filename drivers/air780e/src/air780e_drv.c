 ...
 */
pre_execution(160) static void air780e_pool_boot_init(void)
{
 ...
 */
static int air780e_uart_xchg(struct air780e_device* d, const uint8_t* tx, size_t tx_len,
