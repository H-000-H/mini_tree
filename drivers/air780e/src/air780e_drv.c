 ...
 */
pre_execution(PRE_EXEC_PRIO_DRIVER_POOL) static void air780e_pool_boot_init(void) { COMPAT_IGNORE_RESULT(osal_pool_init(&s_air780e_pool_ctrl, s_air780e_used, AIR780E_POOL_COUNT)); }
