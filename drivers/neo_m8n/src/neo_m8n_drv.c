 ...
 */
static int neo_m8n_uart_xchg(struct neo_m8n_device* d, const uint8_t* tx, size_t tx_len,
...
/**
 * @brief NEO_M8N_CMD_READ_NMEA 实现：读满一帧 NMEA（到 \n 为止）
 */
