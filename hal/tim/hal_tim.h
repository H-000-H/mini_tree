...
#define HAL_TIM_CHANNELS_INSTANCE_MAX 4
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_device_init(hal_tim_device* pdev,
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_pwm_update(hal_tim_device* pdev, uint32_t channel,
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_interrupt_config(hal_tim_device* pdev,
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_capture_value(const hal_tim_device* pdev,
     ...
     * @return 成功返回 MINI_OK, pdev 或 value 为空返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_encoder_value(const hal_tim_device* pdev,
                                                            uint32_t* value);
    /**
     * @brief 获取霍尔换向捕获值
     * @param[in] pdev 定时器设备句柄
     ...
     * @return 成功返回 MINI_OK, pdev 或 value 为空返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_hall_value(const hal_tim_device* pdev,
                                                         uint32_t* value);
    /**
     * @brief 强制停止定时器接口
     * @param[in] pdev 定时器设备句柄
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_encoder_start(hal_tim_device* pdev,
     ...
     * @return 成功返回 MINI_OK, pdev 或 value 为空返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_autoreload(const hal_tim_device* pdev,
                                                         uint32_t* value);
    /**
     * @brief 设置预分频器 (PSC)
     * @param[in] pdev 定时器设备句柄
     ...
     * @return 成功返回 MINI_OK, pdev 或 value 为空返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_prescaler(const hal_tim_device* pdev,
                                                        uint32_t* value);
    /**
     ...
     * @return 成功返回 MINI_OK, pdev 或 value 为空返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_clock_division(const hal_tim_device* pdev,
                                                             uint32_t* value);
    /**
     ...
     * @return 成功返回 MINI_OK, pdev 或 value 为空返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_tim_get_counter_mode(const hal_tim_device* pdev,
                                                           uint32_t* value);
    /**
