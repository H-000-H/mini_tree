...
COMPAT_WEAK int hal_can_transmit(struct hal_can_dev* pdev, const struct can_frame* frame, uint32_t timeout_ms)
{
    (void)pdev;
    (void)frame;
    (void)timeout_ms;
...
COMPAT_WEAK int hal_can_receive(struct hal_can_dev* pdev, struct can_frame* frame, uint32_t fifo, uint32_t timeout_ms)
{
    (void)pdev;
    (void)frame;
    (void)fifo;
