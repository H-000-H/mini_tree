...
#else
MINI_WEAK int hal_i2s_bus_host_init(struct hal_i2s_bus_host* host, int hw_idx, const struct hal_i2s_bus_config* cfg)
{
    (void)host;
    (void)hw_idx;
    (void)cfg;
...
MINI_WEAK int hal_i2s_dev_init(struct hal_i2s_dev* pdev, struct hal_i2s_bus_host* host, const struct hal_i2s_device_config* cfg)
{
    (void)pdev;
    (void)host;
    (void)cfg;
...
MINI_WEAK int hal_i2s_sync(struct hal_i2s_dev* pdev, const uint16_t* tx, uint16_t* rx, size_t samples, uint32_t timeout_ms, uint32_t xfer_mode)
{
    (void)pdev;
    (void)tx;
    (void)rx;
...
MINI_WEAK int hal_i2s_dma_circ_write(struct hal_i2s_dev* pdev, const uint16_t* data, uint32_t samples)
{
    (void)pdev;
    (void)data;
    (void)samples;
...
MINI_WEAK int hal_i2s_transfer_async(struct hal_i2s_dev* pdev, const uint16_t* tx, uint16_t* rx, size_t samples, hal_i2s_callback_t cb,
                                     void* userdata)
{
    (void)pdev;
    (void)tx;
