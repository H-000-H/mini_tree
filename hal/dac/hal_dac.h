...
extern "C"
{
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_dac_device_init(hal_dac_device* pdev,
     ...
     * @return 成功返回 MINI_OK, 失败返回 MINI_ERR_INVAL
     */
    int MINI_WARN_UNUSED_RESULT hal_dac_get_dma_progress(hal_dac_device* pdev,
                                                           uint32_t* remaining);
     ...
     */
    int MINI_WARN_UNUSED_RESULT hal_dac_write_dma_buffer(hal_dac_device* pdev,
