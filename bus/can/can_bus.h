 ...
 */
int can_bus_host_init(struct device* pdev, const struct hal_can_bus_config* cfg) MINI_WARN_UNUSED_RESULT;
/**
 ...
 * @return 成功返回 MINI_OK, 失败返回 VFS_ERR_*
 */
int can_bus_client_register(struct device* pdev, struct can_bus_client** out) MINI_WARN_UNUSED_RESULT;
/**
 ...
 * @return 成功返回 MINI_OK, 失败返回 VFS_ERR_*
 */
int can_bus_transmit(struct device* pdev, const struct can_frame* frame, uint32_t timeout_ms) MINI_WARN_UNUSED_RESULT;
/**
 ...
 */
int can_bus_receive(struct device* pdev, struct can_frame* frame, uint32_t fifo, uint32_t timeout_ms) MINI_WARN_UNUSED_RESULT;
/**
 * @brief 配置 CAN 过滤器
 * @param[in] pdev client device
 ...
 * @return 成功返回 MINI_OK, 失败返回 VFS_ERR_*
 */
int can_bus_filter_config(struct device* pdev, const struct hal_can_filter_config* filter) MINI_WARN_UNUSED_RESULT;
