...
| Keil 5 工程 / Keil 5 projects | **不接受**传统 Keil 5（经典 µVision / MDK）工程相关的 PR、issue、分支；兼容工具请走独立仓或 `tools/` 子模块，可收录进 [docs/ecosystem.md](docs/ecosystem.md)。详见 [docs/keil_integration.md](docs/keil_integration.md) §4 / **No** traditional Keil 5 (classic µVision / MDK) project PRs, issues, or branches; compatibility tools belong in a separate repo or `tools/` submodule and may be listed in [docs/ecosystem.md](docs/ecosystem.md). See [docs/keil_integration.md](docs/keil_integration.md) §4 |
